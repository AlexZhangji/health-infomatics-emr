...
<body onload="javascript:document.login_form.authUser.focus();" >
  ...
  <div >
      <img class="LoginLogo" src="../pic/sites/images/Global_Brigades_Logo.png" alt="Login Image" style="width:290px;">
  </div>
          ...
          <table width="100%">
            <?php if (count($result) != 1) { ?>
              <tr>
                ...
                <tr><td align='center' class='text' style='color:red'>
                ...
                <?php endif; ?>
                <div class="group">
                  <input class="entryfield used" type="text" name="authUser" id="username" >
                  <span class="highlight"></span><span class="bar"></span>
                  <label>Name</label>
                </div>

                <div class="group">
                  <input class="entryfield used" type="password" name="clearPass"  id="password">
                  <span class="highlight"></span><span class="bar"></span>
                ...
                <tr><td align='center'> &nbsp;
                <input class="button buttonBlue" type="submit" onClick="transmit_form()" value="<?php echo xla('Login');?>" >
                </td>
                </tr>
